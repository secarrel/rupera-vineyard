...
![Rupera Vineyard Logo](documentation/read_me_images/logo_rupera_vineyard.png)
# *Rupera Vineyard*
...
+ #### Navigation ![Navbar](documentation/read_me_images/navbar_desktop.png)
...
- The site was deployed to GitHub pages. These are the steps of deployment: 
  - In the [GitHub repository](https://github.com/secarrel/rupera-vineyard), navigate to the Settings tab.
...
The live link can be found [here](https://secarrel.github.io/rupera-vineyard/)
...
+ #### Content
    ...
    - Inspiration for the 'hero-grow' animation with the slightly transparent box of text on-top, on the home page, came from [Code Institutes 'Love Running'](https://github.com/Code-Institute-Solutions/Love-Running-Solutions) project. 
    - The responsive gallery idea is also adapted [Code Institute's 'Love Running'](https://github.com/Code-Institute-Solutions/Love-Running-Solutions) project.
    - The timeline display for upcoming events is inspired by [Code Institute's 'Resume'](https://github.com/Code-Institute-Solutions/resume-miniproject-bootstrap4) project.
    - The responsive hamburger navbar is adapted from [Bootstrap](https://getbootstrap.com/docs/4.6/).
    - I was given permission to use the read-me from [Iuliia Konovalova's](https://github.com/https://github.com/IuliiaKonovalova)  project ['Animal Shelter'](https://github.com/IuliiaKonovalova/animal_shelter)
...
- [Iuliia Konovalova](https://github.com/https://github.com/IuliiaKonovalova) was really supportive throughout this project and provided excellent guidance on best practice, the read me and testing. 
- [Code Institute](https://codeinstitute.net/) provided me with the knowledge and skills needed to create the project.
